...
ListView BestSellerProducts(data , int CusID){
  return  ListView.builder(
      ...
      itemBuilder: (context,index)=>
          ItemCard(product: /// here just to test the app shoulde be data[index]
          products[index],
              Press:  () => Navigator.push(context,
                  MaterialPageRoute(builder: (context) => ProductDetails(
                    product: products[index],CUSTID: CusID,))
              ),
          )
  );
}
      ...
      color: Colors.white,
        child:Column(
          ...
          children: <Widget>[
            SizedBox(
              height: 200,
                child: Image.network("https://cdn.shopify.com/s/files/1/0011/9783/4252/products/20_375a8763-f5d7-4184-a352-4523ef713733_900x.jpg?v=1576267132",
                    fit:BoxFit.fill
                   )
            ),
            SizedBox(height:5 ,),
...
List<Product> products=[
  Product(
    ...
    title:"Red Dress",
    price: 600,
    image:"assets/reddress.jpg",
    description: "French Night Dress",
  ...
  Product(
    ...
    description: "Turkey cotton dress",
